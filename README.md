...
```bash
sudo iptables -t nat -A OUTPUT -p tcp udp --dport 53 -j REDIRECT --to-ports 5353
sudo iptables -t nat -A OUTPUT -p tcp udp --dport 80 -j REDIRECT --to-ports 9040
sudo iptables -t nat -A OUTPUT -p tcp udp --dport 443 -j REDIRECT --to-ports 9040
```
