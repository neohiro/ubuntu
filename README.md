...
Linux Ubuntu commands after fresh install, automated in attached shell files (with extra hardening, please go through the shell). The server version does not harden SSH as much. Offers a more secure starting point for any new super user.
